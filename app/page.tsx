            ...
            >
              ...
              <div className="animate-fade-up delay-200">
                ...
                <p className="text-lg text-gray-600 leading-relaxed max-w-xl">
                  Stop paying thousands for a world-class website. We provide the design, development, and setup completely free. You just cover the low monthly cost for hosting and ongoing support.
                </p>
              </div>
              ...
              <div className="flex items-center space-x-6 pt-6 animate-fade-up delay-400">
                <div className="flex items-center group">
                  <Users className="h-5 w-5 text-gray-900 mr-2 group-hover:scale-110 transition-transform duration-300" />
                ...
                <div className="flex items-center group">
                  <Clock className="h-5 w-5 text-gray-900 mr-2 group-hover:scale-110 transition-transform duration-300" />
